...
const fields: Array<{ key: Exclude<keyof ExtractedEvidence, "imageContainsRelevantFinancialEvidence" | "notes">; label: string; placeholder: string }> = [
...
export default function Home() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
      ...
      {evidence && <section className={`mt-8 rounded-2xl border bg-white p-6 shadow-card sm:p-8 ${evidence.imageContainsRelevantFinancialEvidence ? "border-brand-100" : "border-amber-200"}`}>
        {evidence.imageContainsRelevantFinancialEvidence ? (
